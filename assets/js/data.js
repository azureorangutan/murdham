...
abilities: [0, 0, 0],
skills: {
"Acrobatics": "Reduce difficulty when balancing or leaping, or combine balancing or leaping with sprinting, sneaking... When you fall, you reduce the falling distance by 4 metres if you pass the AGI save, and by 2 metres even if you fail.",
...
"Stealth": "Reduce difficulty when sneaking, or sneak while sprinting, climbing... When your group is detected by another group, make an AGI save: if you pass you managed to stay hidden.",
},
mana: 0,
assets: [
"clothes (dark cloak)",
...
"Swim": "Reduce difficulty when swimming, or combine swimming with sprinting, sneaking... Your attacks aren't impaired while in water. You can hold your breath for twice as long.",
},
mana: 0,
assets: [
...
mana: 0,
assets: [
"clothes (fake city watch uniform, won't stand close scrutiny)",
...
abilities: [0, 0, 0],
skills: {
"Drive carts": "Reduce difficulty when driving a cart. When your cart makes a full movement in combat, you can still use your main action to attack, but only after the movement is completed.",
"Ride": "Reduce difficulty when riding a tamed beast, ride without a <i>saddle</i>, or ride an untamed beast. When your mount makes a full movement in combat, you can still use your main action to attack, but only after the movement is completed.",
},
mana: 0,
assets: [
...
abilities: [0, 0, 0],
skills: {
"Steal": "You can steal items of bulk ½ without a save, or items of bulk 1 with a save.",
"Stealth": "Reduce difficulty when sneaking, or sneak while sprinting, climbing... When your group is detected by another group, make an AGI save: if you pass you managed to stay hidden.",
},
mana: 0,
assets: [
...
abilities: [0, 0, 0],
skills: {
"Climb": "Reduce difficulty when climbing, or combine climbing with sprinting, sneaking... Your attacks aren't impaired while climbing.",
"Piercing strike": "If you roll higher than the target's armour value with an attack you ignore it and inflict full damage. If you roll equal or lower, you inflict no damage as usual. This skill doesn't work in situations where you are required to pass a WIT save to hit as it requires full precision.",
},
mana: 0,
assets: [
...
abilities: [0, 0, 0],
skills: {
"Leadership": "Reduce difficulty while inspiring and keeping the loyalty of followers. Once per stretch, as a main action, you can rally all <i>frightened</i> and <i>terrified</i> allies within range 2. They make a group WIT save and those who succeed recover immediately.",
...
abilities: [0, 0, 0],
skills: {
"Alchemy": "You can read and write. You can speak and understand Classic. You can craft alchemical substances, such as <i>acid vials</i>, <i>alchemist's fire</i>, <i>flash powder</i>, and <i>smoke bombs</i>. This requires raw materials (worth ¼ of the item) and an alchemist's workshop. You can craft a batch of 2 doses of the same substance in a watch.",
