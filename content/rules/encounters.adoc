...
Proficient characters can steal an item with bulk ½ automatically, and an item with bulk 1 (or two with bulk ½) by passing an AGI save.
...
Professional merchants typically have this skill and further reduce price by half, because they aim to make a profit by reselling the item.
...
You can assume they interact with professional merchants with the _bargain_ skill.
