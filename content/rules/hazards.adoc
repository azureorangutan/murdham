...
Weapons and sharp objects can be coated with one or two doses of the poison, which are delivered on the first attack inflicting at least 1 damage.
Coating a weapon with poison takes a round.
