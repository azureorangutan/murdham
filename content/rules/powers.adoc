...
She first casts _eldritch blast_ with 2 EPs (her current mana).
...
She could choose to get 1 EP by suffering more corruption or taking longer to cast as she did before, but decides against it.
