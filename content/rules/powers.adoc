...
|9 |
The invoker and all characters within range 1 are exposed to the '`demon pox`' disease (see link:../hazards/#disease[Disease]).

|10 |
The invoker develops a random mutation (roll on the link:../corruption/#tb_mutations[Mutations] table).
