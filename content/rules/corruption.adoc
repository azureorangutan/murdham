...
It is usually reduced only after suffering soulblight, which isn't a positive experience!
...
Characters who suffer soulblight take direct damage equal to the rolled number, but corruption is also reduced by the same amount.
...
Characters who suffer critical damage due to soulblight develop a permanent mutation determined by rolling on the <<tb_mutations>> table, in addition to the usual effects of critical damage.
