...
You gain the _frightening_ trait.
...
You gain the _undead_ and _frightening_ traits, but your STR and AGI are permanently reduced by d4.
...
The cost is halved if characters have their own food and water, or their own place to sleep.
