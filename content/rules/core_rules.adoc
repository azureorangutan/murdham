...
Even though he has lost more than half his health at once, he doesn't suffer critical damage it was due to STR loss rather than damage.
...
D6: 1) a specific group of people; 2) users of profane powers; 3) users of sacred powers; 4) demons; 5) undead; 6) animals.
...
* Re-roll, keeping the most favourable results: a failed save, a lost contest, damage rolls, soulblight checks, chance rolls (x:y chances), rolls on a table.
...
If consumed there is a 1:4 chance that it exposes you to a disease chosen by the GM.
...
Players control their followers as their own character, assuming they are giving them orders.
...
Characters can't move into or through a zone or zone border which is already full.
