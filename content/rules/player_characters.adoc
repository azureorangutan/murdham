...
. *Assets*.
You start with d8ʂ, the items and followers granted by your career, and the items and shillings you get by rolling on the <<tb_starting_items>> table.
If you start with sacred or profane _power scrolls_, roll on the <<tb_sacred_powers>> or <<tb_profane_powers>> tables respectively to determine what power they contain.
