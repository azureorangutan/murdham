...
Some skills grant the ability to craft certain items.
Crafting an item takes a whole watch and requires a suitable workshop or tools, as indicated in the skill description.
