...
Items can't heal like characters, but can be repaired.
...
The bulk of what's on the vehicle doesn't count towards the encumbrance of characters or operating it.
