...
*Followers*: wolf (Lucius, tamed, bites anyone else approaching too close).
...
*Items*: clothes (comfortable and with generous pockets), lockpicks.
...
*Followers*: light horse (Bartadan, trained as a mount and for combat, old and lame: permanent _hobbled_ condition).
...
*Items*: clothes (dusty and sweaty), lockbox & key, scroll (sealed letter, no addressee).
...
*Items*: alcoholic drink (good wine, expensive), clothes (ostentatious fripperies, old and full of holes), signet ring (proof of your identity).
...
*Items*: clothes (spotless black coat), cure, medicine box.
...
*Followers*: small dog (Brutus, trained to hunt, especially rats, small but vicious).
...
*Items*: clothes (greenish cloak), simple great weapon (woodcutting axe).
