...
* *Darkroot* (16ʂ, bulk ½).
_Consumable_.
Pass a STR save or be _groggy_ until the end of the watch, as pleasant hallucinations overwhelm you. Automatically fail if you take 2 within a stretch. After the effect wears off, pass a WIT save or become _addicted_.
