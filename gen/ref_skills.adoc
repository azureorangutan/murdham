...
* *Politics*.
You are literate. You can speak Classic. Knowledgeable in all fields of civil and political lore, such as laws, structures of power, bureaucracy, processes, etc. You know whom to bribe, what to offer, and how to go about it: when you spend a few minutes talking with someone, you can ask the GM to reveal if they are bribable, and if so what that would require.
