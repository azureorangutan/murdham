...
* *Bargain*.
You purchase items at half price unless the seller also has this skill. Conversely, you sell at full price even if the seller has this skill. You are able to accurately estimate the value of most items by taking a quick look. You are proficient at persuasion attempts pertaining getting a better deal for something.
