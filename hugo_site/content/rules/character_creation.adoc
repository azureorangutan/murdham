...
next: /rules/abilities_and_saves
---
:toc:
...
** You additionally share a single _candle_ and _flint & tinder_ with the other Players.

** If you are a _priest_ or a _wizard_, you start with a _power scroll_ without a specified power.
Roll for it on the <<tb_sorcerous_powers>> or <<tb_sacred_powers>> tables.
