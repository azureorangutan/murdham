...
static_gen_fn!(starting_weapons, gen_starting_weapons, Item, Item, {
    vec![
        ...
        Item::new(Some("scythe"), ItemKind::SimpleGreatWeapon, None),
...
static_gen_fn!(starting_items, gen_starting_items, Item, Item, {
    vec![
        ...
        Item::from(ItemKind::ButterflySting),
        ...
        Item::new(None, ItemKind::SignetRing, Some("stolen")),
        Item::new(None, ItemKind::LuckyCharm, Some("cornicello")),
        Item::from(ItemKind::Marbles),
        Item::from(ItemKind::Muzzle),
        Item::from(ItemKind::PipeAndTobacco),
        Item::from(ItemKind::RopeLadder),
        Item::from(ItemKind::Saddle),
    ]
});
